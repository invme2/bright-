...
import {SearchIndex, tokenizeCjkByCodePoint} from './SearchIndex.js';

describe('search index', function () {
    test('initializes search index', async () => {
        const contentApiUrl = 'http://localhost:3000/ghost/api/content';
        const contentApiKey = '69010382388f9de5869ad6e558';
        const searchIndex = new SearchIndex({contentApiUrl, contentApiKey});
    ...
    test('searching works when dir = rtl also', async () => {
        const contentApiUrl = 'http://localhost:3000/ghost/api/content';
        const contentApiKey = '69010382388f9de5869ad6e558';
        const searchIndex = new SearchIndex({contentApiUrl, contentApiKey, dir: 'ltr'});
